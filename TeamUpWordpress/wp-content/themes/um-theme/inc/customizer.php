...
--------------------------------------------------------------*/
	...
	// Ultimate Member SEO
	$wp_customize->add_section( 'customizer_section_um_seo',
		array(
			'title' 			=> esc_html__( 'Ultimate Member SEO', 'um-theme' ),
			'capability' 		=> 'edit_theme_options',
			'priority' 			=> 5,
			'panel' 			=> 'customizer_panel_um_plugin_panel',
		)
...
--------------------------------------------------------------*/
	...
	// Enable ProfilePage Schema
	$wp_customize->add_setting( 'customization[um_theme_seo_enable_schema_profilepage]' ,
		array(
			'default' 	=> false,
			'type' 		=> 'option',
			'transport' => 'refresh',
		...
		$wp_customize->add_control( 'um_theme_seo_enable_schema_profilepage',
			array(
				'label'      => esc_html__( 'Enable ProfilePage Schema', 'um-theme' ),
				'section'    => 'customizer_section_um_seo',
				'settings'   => 'customization[um_theme_seo_enable_schema_profilepage]',
			    'priority'   => 1,
			    'type'       => 'checkbox',
			)
		);
