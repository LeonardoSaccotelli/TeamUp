...
if ( ! function_exists( 'um_theme_customizer_head_styles' ) ) {
	function um_theme_customizer_head_styles() {
		...
		$css .= '
			...
			#bs-navbar-profile a:hover,#bs-navbar-primary a:hover{ color: ' . sanitize_hex_color( $menu_text_hover_color ) . '!important;}
		...
		if ( function_exists( 'um_followers_plugins_loaded' ) ) :
			...
			$css .= '
				...
				.um-activity-like.active .um-faicon-thumbs-up{
					color:' . sanitize_hex_color( $defaults['um_theme_um_plug_accent_color'] ) . ' !important;
				}
			';
		endif;
		...
		if ( class_exists( 'WeDevs_Dokan' ) ) :
			$css .= '
				...
				.profile-info .store-name {
				    color:' . sanitize_hex_color( $defaults['um_theme_dokan_store_name_color'] ) . ' !important;
				}

				.dokan-store-info {
				    color:' . sanitize_hex_color( $defaults['um_theme_dokan_store_info_color'] ) . ' !important;
				}
		...
		if ( class_exists( 'Easy_Digital_Downloads' ) ) :
			$css .= '
				#edd-purchase-button, .edd-submit, [type=submit].edd-submit {
				    font-size:' . esc_attr( $defaults['um_theme_edd_button_font_size'] ) . ' !important;
				}
		...
		wp_add_inline_style( 'um-stylesheet', wp_strip_all_tags( $css_minified ) );
	}
}