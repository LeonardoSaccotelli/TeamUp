...
if ( absint( $defaults['um_header_profile_position'] ) == 2 ) {
    ...
    add_action( 'um_theme_header_profile_after', 'um_theme_header_friend_request_modal', 8 );
    add_action( 'um_theme_header_profile_after', 'um_theme_header_activity_modal', 10 );
    /**
     * Rearrange Notification Icon.
     */
    if ( function_exists( 'um_notifications_check_dependencies' ) ) {
...
if ( ! function_exists( 'um_notification_rearrrange' ) ) {
    function um_notification_rearrrange() {
        if ( function_exists( 'um_notifications_check_dependencies' ) ) {
            global $defaults;
            if ( absint( $defaults['um_show_floating_notification'] ) === 2 ) {
            ...
            if ( absint( $defaults['um_header_profile_position'] ) == 2 ) {
                ...
                add_action( 'um_theme_header_profile_after', 'um_theme_header_notification_modal', 10 );
            }
        }
    }
}
...
/*--------------------------------------------------------------
## 7.0 Ultimate member SEO
--------------------------------------------------------------*/

/**
 * Add JSON-LD structured data for Ultimate Member pages.
 */
...
if ( ! function_exists( 'um_theme_um_profile_structured_data' ) ) {
    function um_theme_um_profile_structured_data() {
        if ( class_exists( 'UM' ) ) {
            ...
            if ( $defaults['um_theme_seo_enable_schema_profilepage'] == true ) {
