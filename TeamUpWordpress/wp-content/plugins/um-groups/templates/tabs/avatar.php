	...
	<div class="um-col-alt">
		<?php if( has_post_thumbnail( $group_id ) ) { ?>
			<div class="um-left um-half">
				<input type="submit" name="um_groups_upload_avatar" value="<?php esc_attr_e( 'Conferma Modifica Copertina', 'um-groups' ) ?>" class="um-button" />
			</div>
			<div class="um-right um-half">
				<input type="submit" name="um_groups_delete_avatar" value="<?php esc_attr_e( 'Rimuovi Copertina', 'um-groups' ) ?>" class="um-button um-alt" />
			</div>
		<?php } else { ?>
			<input type="submit" name="um_groups_upload_avatar" value="<?php esc_attr_e( 'Aggiungi Copertina', 'um-groups' ) ?>" class="um-button" />
		<?php } ?>
