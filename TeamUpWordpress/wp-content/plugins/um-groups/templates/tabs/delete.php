...
<form action="" method="post">
	...
	<p><strong><?php _e( "Una volta eliminato il progetto non potrà essere recuperato", "um-groups" ); ?></strong></p>
	
	<div class="um-col-alt">
		<input type="submit" name="um_groups_delete_group" value="<?php _e( "Cancella gruppo permanentemente", "um-groups" ); ?>" class="um-button" />
	</div>
