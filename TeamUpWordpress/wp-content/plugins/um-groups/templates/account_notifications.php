...
<div class="um-field" data-key="">
	<div class="um-field-label"><strong><?php _e( 'Progetti', 'um-messaging' ); ?></strong></div>
	...
	<?php if ( $show_post_notification ) { ?>
		<div class="um-field-area">
			<label class="um-field-checkbox<?php if ( ! empty( $post_notification ) ) { ?> active<?php } ?>">
				...
				<span class="um-field-checkbox-option"><?php _e('Notifica quando viene aggiunto un post','um-groups'); ?></span>
			</label>
	...
	if ( $show_comment_notification ) { ?>
		<div class="um-field-area">
			<label class="um-field-checkbox<?php if ( ! empty( $comment_notification ) ) { ?> active<?php } ?>">
				...
				<span class="um-field-checkbox-option"><?php _e('Notifica quando viene aggiunto un commento','um-groups'); ?></span>
			</label>
			<div class="um-clear"></div>
		</div>
	<?php } ?>
