	...
	<form class="um-group-form um-groups-search-form">
		...
		<?php if( $arr_tags ) : ?>
			<div class="um-field um-field-select um-field-type_select">
				<select name="tags" class="um-form-field um-s1" style="<?php esc_attr_e( $select_style ); ?>">
					<option value=""><?php _e( "Tutte le categorie", "um-groups" ); ?></option>
		...
		<div class="um-col-alt">
			<div class="um-left um-half">
				<input type="submit" value="<?php esc_attr_e( "Cerca", "um-groups" ); ?>" class="um-button">
			</div>
			<div class="um-right um-half">
				<a href="<?php echo esc_url( get_the_permalink() ); ?>" class="um-button um-alt"><?php _e( 'Rimuovi filtri', 'um-groups' ); ?></a>
			</div>
