...
<?php if( !UM()->Groups()->discussion()->has_group_discussions( $um_group_id ) && !$show_pending_approval ) { ?>
	<div  class="um-groups-discussion-empty um-profile-note" style="display:block;">
		<?php _e( "Nessun messaggio disponibile", "um-groups" ); ?>
	</div>
<?php } ?>
...
<div class="um-groups-widget um-groups-clone">
		...
		<div class="um-groups-left um-groups-author">
			...
			<div class="um-groups-author-meta">
				...
				<span class="um-groups-metadata">
					<a href=""><?php _e( 'Adesso', 'um-groups' ); ?></a>
				</span>
			</div>
		</div>
		...
		<div class="um-groups-right">
			...
			<?php if( is_user_logged_in() ) { ?>
				...
				<div class="um-groups-dialog um-groups-tool-dialog">
					...
					<a href="#" class="um-groups-manage" data-cancel_text="<?php _e( 'Annulla modifica', 'um-groups' ); ?>" data-update_text="<?php _e( 'Update', 'um-groups' ); ?>"><?php _e( 'Edit', 'um-groups' ); ?></a>

					<a href="#" class="um-groups-trash" data-msg="<?php _e( 'Sei sicura di voler modificare il messaggio?', 'um-groups' ); ?>"><?php _e( 'Delete', 'um-groups' ); ?></a>
	...
	<div class="um-groups-foot status">
		<div class="um-groups-left um-groups-actions">
			<div class="um-groups-like"><a href="#"><i class="um-faicon-thumbs-up"></i><span class=""><?php _e( 'Mi piace', 'um-groups' ); ?></span></a></div>
			<?php if( UM()->Groups()->discussion()->can_comment() ) { ?>
				<div class="um-groups-comment"><a href="#"><i class="um-faicon-comment"></i><span class=""><?php _e( 'Commenta', 'um-groups' ); ?></span></a></div>
			<?php } ?>
		</div>
		<div class="um-clear"></div>
	</div>
	...
	<script type="text/template" id="tmpl-um-groups-comment-edit">
		<div class="um-groups-commentl um-groups-comment-area" style="padding-top:0;padding-left:0;">
			...
			<div class="um-groups-right">
				<a href="javascript:void(0);" class="um-groups-comment-edit-cancel"><?php _e( 'Annulla modifica', 'um-activity' ); ?></a>
				<a href="javascript:void(0);" class="um-button um-groups-comment-post um-disabled"><?php _e( 'Aggiorna', 'um-activity' ); ?></a>
			</div>
			<div class="um-clear"></div>
		</div>
	</script>
