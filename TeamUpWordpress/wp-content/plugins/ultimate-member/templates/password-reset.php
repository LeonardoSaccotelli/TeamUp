				...
				<div class="um-field um-field-block um-field-type_block">
					<div class="um-field-block">
						<div style="text-align:center;">
							<?php _e( 'Ti abbiamo inviato un link per la reimpostazione della password alla tua e-mail. Controlla la tua casella di posta.', 'ultimate-member' ); ?>
						</div>
					</div>
				</div>
			<?php } else { ?>
						...
						<div class="um-field-block">
							<div style="text-align:center;">
								<?php if ( 'expiredkey' == $_GET['updated'] ) {
									_e( 'Il link per la reimpostazione della password è scaduto. Si prega di richiedere un nuovo link qui sotto.', 'ultimate-member' );
								} elseif ( 'invalidkey' == $_GET['updated'] ) {
									_e( 'Il link di reimpostazione della password sembra non essere valido. Si prega di richiedere un nuovo link qui sotto.', 'ultimate-member' );
								} ?>
							</div>
						</div>
					</div>
				<?php } else { ?>
					<div class="um-field um-field-block um-field-type_block">
						<div class="um-field-block">
							<div style="text-align:center;">
								<?php _e( 'Per reimpostare la password, inserisci il tuo indirizzo email o il tuo nome utente qui sotto', 'ultimate-member' ); ?>
							</div>
						</div>
					</div>
				<?php }
				...
				<div class="um-col-alt um-col-alt-b">
					...
					<div class="um-center">
						<input type="submit" value="<?php esc_attr_e( 'Resetta Password', 'ultimate-member' ); ?>" class="um-button" id="um-submit-btn" />
					</div>
